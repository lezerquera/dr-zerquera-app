...
router.get('/accepted', async (req: express.Request, res: express.Response) => {
    try {
...
router.post('/accepted', verifyToken, isAdmin, async (req: express.Request, res: express.Response) => {
...
router.get('/accepted-details', async (req: express.Request, res: express.Response) => {
     try {
